...
# → /home1/singhama/gfm/prodigy/state/exp4_train1_midterm_lp_*/state_dict

# Step 2 — fine-tune on covid LP
bash step2_submit_finetune_covid.sh /home1/singhama/gfm/prodigy/state/exp4_train1_midterm_lp_<run>/state_dict
# → /home1/singhama/gfm/prodigy/state/exp4_train2_midterm_lp_to_covid_lp_*/state_dict

# Step 3 — eval on ukr_rus (NM + LP + PL, shots=1,5,10)
bash step3_submit_eval_ukr_rus.sh /home1/singhama/gfm/prodigy/state/exp4_train2_midterm_lp_to_covid_lp_<run>/state_dict
```
...
# checkpoint: /home1/singhama/gfm/prodigy/state/exp4_train2_midterm_lp_to_covid_lp_16_04_2026_17_31_13/state_dict
