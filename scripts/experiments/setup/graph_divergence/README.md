...
- Plots + write-up: [`graph_divergence.ipynb`](../../analysis/graphs/structure/graph_divergence/graph_divergence.ipynb),
...
/home/mhchu/miniconda3/envs/prodigy/bin/python \
    scripts/experiments/analysis/graphs/structure/graph_divergence/compute_graph_divergence.py \
