...
On Tucker, from a dedicated worktree and with GPUs 0-3 idle:
...
`wait_and_run_tucker.sh` serializes behind the currently queued paper work and requires
two minutes of stable idle GPU state before launch. It never touches GPUs 4-7.
