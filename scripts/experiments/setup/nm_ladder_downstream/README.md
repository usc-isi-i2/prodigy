...
`analysis/evaluation/task_tables/{node_classification,node_regression,static_link_prediction}/data/`. The ladder
...
`analysis/objectives/multitask/multitask_ssl/FINDINGS_rescore.md`). `run_pair_lp_sweep.sh` drives
...
Into `analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream/data/`:
...
Analysis and findings go in `analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream/`, not here.
