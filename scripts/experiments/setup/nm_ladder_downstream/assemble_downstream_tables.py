...
encoders back into the 24 (order, rung) rows through ``row_map.csv``:
  ...
  node regression      analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream/data/reg_probe/<dataset>__reg_probe.csv
  node classification  analysis/evaluation/task_tables/node_classification/data/node_classification.csv
  static link pred     analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream/data/pair_lp/<dataset>__pair_lp.csv
...
Emits into ``analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream/data/``:
