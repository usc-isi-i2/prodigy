#!/usr/bin/env bash
# Train one phase of the fixed-exposure, fair-2-hop NM ladder.
#
#   PHASE=A ./run_all_train_tucker.sh
#   PHASE=robustness ./run_all_train_tucker.sh
#   PHASE=all ./run_all_train_tucker.sh
#   PHASE=smoke ./run_all_train_tucker.sh
