...
GD = ROOT / "scripts/experiments/analysis/graphs/structure/graph_divergence"
PFC = ROOT / "scripts/experiments/analysis/graphs/structure_features/path_feature_coupling"
