...
# writes reg/slp/cls rows keyed by model=arm into scripts/experiments/analysis/*/data/*.csv
...
```bash
python3 $PAIRS/aggregate_results.py --plotting-root scripts/experiments/analysis
```
