...
`analysis/evaluation/static_link_prediction_repair/`), and it means the ~1100 rows in
`analysis/evaluation/task_tables/node_regression/data/node_regression.csv` are void as a measure of
