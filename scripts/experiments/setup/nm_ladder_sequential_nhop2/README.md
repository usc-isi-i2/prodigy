...
`analysis/nm_ladder_nhop2/data/nm_ladder_nhop2_long.csv`:

```bash
python3 scripts/experiments/analysis/nm_ladder_sequential_nhop2/assemble_results.py \
  --log-root /dataMeR1/phil/gfm/prodigy-nmlh2seq/log \
  --control-long /path/to/nm_ladder_nhop2_long.csv
python3 scripts/experiments/analysis/nm_ladder_sequential_nhop2/plot_comparison.py
```
