#!/usr/bin/env python3
"""Generate the 36 pair configs from the frozen final-core base config."""
...
from pair_plan import build_models


HERE = Path(__file__).resolve().parent


def render(base: str, model_id: str, sources: tuple[str, str]) -> str:
    marker = "prefix: nmpair_base"
    ...
    return text.rstrip() + f'\nneighbor_sampling_source_subset: "{sources[0]},{sources[1]}"\n'
...
def main() -> int:
    ...
    print(f"wrote 36 configs to {args.output_dir}")
    return 0
