...
LOG_ROOT="${LOG_ROOT:-${REPO_ROOT}/log/icl_arch_topology_features}"
...
evaluate_cmd=("$PYTHON" -u -m scripts.experiments.setup.icl_arch_matrix.evaluate_topology_features
  --results "$RESULTS_ROOT/topology_features.jsonl")
aggregate_cmd=("$PYTHON" -m scripts.experiments.setup.icl_arch_matrix.aggregate_topology_features
  --results "$RESULTS_ROOT/topology_features.jsonl"
