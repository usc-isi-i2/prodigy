...
`scripts/experiments/analysis/evaluation/task_tables/*/data/`. Success marker in `/tmp/msc_watcher.log`:
...
- Parse gotcha (worked around in e7dd1c7): `parse_benchmark_eval_logs.py`
  ...
  `../../analysis/objectives/multitask/multitask_ssl_corpora/data/`.
