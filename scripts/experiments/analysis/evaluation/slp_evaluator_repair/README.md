...
| the rescored results | [`../multitask_ssl/data/pair_lp/`](../../objectives/multitask_ssl/multitask_ssl/data/pair_lp/) |
| the defect list + rescore writeup | [`../multitask_ssl/FINDINGS_rescore.md`](../../objectives/multitask_ssl/multitask_ssl/FINDINGS_rescore.md) |
| what the rescore did to the lattice | [`../multitask_ssl/FINDINGS.md`](../../objectives/multitask_ssl/multitask_ssl/FINDINGS.md) |
