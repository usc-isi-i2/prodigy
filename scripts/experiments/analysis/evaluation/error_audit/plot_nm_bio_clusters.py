...
def main():
    ...
    data={t:json.loads((args.data_dir/f"nm_bio_clusters_{t}.json").read_text()) for t in labels}
    weight={t:json.loads((args.data_dir/f"nm_query_weighting_{t}.json").read_text()) for t in labels}
