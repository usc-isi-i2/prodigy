...
DEFAULT_TRANSFER = ROOT / "scripts/experiments/analysis/nm_single_source_matrix_facebook/data/nm_single_source_matrix_9x9_long.csv"
DEFAULT_DIVERGENCE = ROOT / "scripts/experiments/analysis/graph_divergence/data/graph_divergence_data.json"
