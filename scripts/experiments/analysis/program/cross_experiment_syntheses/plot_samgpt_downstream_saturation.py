...
SERIES = (
    (
        "COVID only",
        REPO_ROOT / "scripts/experiments/analysis/transfer/ablations/saturation/samgpt/covid/samgpt_covid_saturation/data/validation_trajectory.csv",
        "#2a78d6",
        "o",
    ),
    (
        "Five-source mixture",
        REPO_ROOT / "scripts/experiments/analysis/transfer/ablations/saturation/samgpt/five_source/samgpt_c5_saturation/data/validation_trajectory.csv",
        "#d85a30",
        "s",
    ),
)
