...
>
> Corrected read: [`../multitask_ssl/FINDINGS.md`](../../objectives/multitask_ssl/multitask_ssl/FINDINGS.md) ·
> defect details: [`../multitask_ssl/FINDINGS_rescore.md`](../../objectives/multitask_ssl/multitask_ssl/FINDINGS_rescore.md).
...
|---|--------|---------|------------------|
| A | Graph diagnostics | [graph_divergence](../../../setup/graph_divergence/README.md), [similarity_vs_transfer](../../graph_characterization/similarity_vs_transfer/similarity_vs_transfer/FINDINGS.md) | Feature-cloud separability predicts transfer (ρ≈−0.92); topology distance barely does. |
| B | NM merged-vs-single (cross-source shortcut) | [nm_transfer_matrix](../../transfer/matrices/prodigy_nm/merged_vs_single/nm_transfer_matrix/RESULTS.md), [nm_cross_source_shortcut](../../transfer/ablations/episode_sampling/nm_cross_source_shortcut/RESULTS.md), [nm_covid_midterm](../../transfer/matrices/prodigy_nm/merged_vs_single/nm_covid_midterm/RESULTS.md), [sampling_strat_comparison](../../transfer/ablations/episode_sampling/sampling_strat_comparison/) | Inversion doesn't reproduce; within-source > naive; balanced rescues small domains. |
| C | NM transfer geometry (8×8 + ladder) | [nm_single_source_matrix](../../transfer/matrices/prodigy_nm/single_source/nm_single_source_matrix/FINDINGS.md), [nm_ladder](../../transfer/ladders/prodigy_nm/canonical/nm_ladder/RESULTS.md) | Specialists beat merged in-domain everywhere; covid/ukr universal donors; cp_hk an island. |
...
| E | SSL-objective studies | [topology_feature_ssl](../../objectives/topology_vs_features/topology_feature_ssl/FINDINGS.md), [multitask_ssl](../../objectives/multitask_ssl/multitask_ssl/FINDINGS.md) | A multi-head objective (E4) fails. ⚠️ The "MIX is the only generalist / LP is a 3-way synergy" reading is superseded — LP is an NM main effect (see banner). |
| F | Frozen-probe strategy benchmark | [pretrain_probe_matrix](../../objectives/probe_matrix/pretrain_probe_matrix/FINDINGS.md), [pretrain_strategy_benchmark](../../../setup/pretrain_strategy_benchmark/README.md), [covid_task_transfer_matrix](../../../setup/covid_task_transfer_matrix/README.md) | Only NM→LP clears a floor; raw features beat all pretraining on regression. |
