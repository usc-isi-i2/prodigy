...
| the rescored results | [`../multitask_ssl/data/pair_lp/`](../multitask_ssl/data/pair_lp/) |
| the defect list + rescore writeup | [`../multitask_ssl/FINDINGS_rescore.md`](../multitask_ssl/FINDINGS_rescore.md) |
| what the rescore did to the lattice | [`../multitask_ssl/FINDINGS.md`](../multitask_ssl/FINDINGS.md) |
