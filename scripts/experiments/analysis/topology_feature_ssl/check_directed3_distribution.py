...
# parents[3] when run as a file; fall back to cwd when piped via stdin (no __file__).
REPO_ROOT = Path(__file__).resolve().parents[3] if "__file__" in globals() else Path.cwd()
