...
```bash
python scripts/experiments/analysis/graph_characterization/feature_geometry/bio_embedding_geometry/analyze.py \
  --data-root /dataMeR1/phil/data \
  --output-dir scripts/experiments/analysis/graph_characterization/feature_geometry/bio_embedding_geometry/data
```
