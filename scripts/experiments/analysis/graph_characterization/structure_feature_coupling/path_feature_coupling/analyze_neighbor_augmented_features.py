...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default="scripts/experiments/analysis/graph_characterization/structure_feature_coupling/path_feature_coupling/data/neighbor_augmented_features.json",
    )
    parser.add_argument(
        "--projection-out",
        default="scripts/experiments/analysis/graph_characterization/structure_feature_coupling/path_feature_coupling/data/neighbor_augmented_3d.csv",
    )
