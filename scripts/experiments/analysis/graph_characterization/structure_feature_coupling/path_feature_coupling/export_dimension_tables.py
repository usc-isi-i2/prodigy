...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="scripts/experiments/analysis/graph_characterization/structure_feature_coupling/path_feature_coupling/data/dimension_diagnostics.json",
    )
    parser.add_argument(
        "--node-out",
        default="scripts/experiments/analysis/graph_characterization/structure_feature_coupling/path_feature_coupling/data/node_distance_per_dimension.csv",
    )
    parser.add_argument(
        "--graph-out",
        default="scripts/experiments/analysis/graph_characterization/structure_feature_coupling/path_feature_coupling/data/graph_identity_per_dimension.csv",
    )
