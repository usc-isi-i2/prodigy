...
Because loading a 75GB graph is heavy, launch this on Tucker yourself, e.g.:
    ...
    python scripts/experiments/analysis/graph_characterization/statistics/graph_divergence/compute_graph_divergence.py \
...
def main() -> None:
    ...
    ap.add_argument("--out", default="scripts/experiments/analysis/graph_characterization/statistics/graph_divergence/data/graph_divergence_data.json")
