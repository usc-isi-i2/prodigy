...
Runs on Tucker, where the graphs live:
    ...
    python scripts/experiments/analysis/graph_characterization/statistics/graph_divergence/compute_structural_subspace.py \
        --data-root /dataMeR1/phil/data \
        --out scripts/experiments/analysis/graph_characterization/statistics/graph_divergence/data/structural_subspace.json
"""
