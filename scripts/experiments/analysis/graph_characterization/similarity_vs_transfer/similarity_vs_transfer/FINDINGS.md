...
Two stages, both on Tucker (see the
[`graph_divergence` setup](../../../../setup/graph_divergence/README.md) and this
experiment's [`setup`](../../../../setup/similarity_vs_transfer/README.md)):

- **Similarity** — [`compute_graph_divergence.py`](../../statistics/graph_divergence/compute_graph_divergence.py)
  ...
  [`graph_divergence_data.json`](../../statistics/graph_divergence/data/graph_divergence_data.json).
...
`~/.pyenv/versions/myenv/bin/python scripts/experiments/analysis/graph_characterization/similarity_vs_transfer/similarity_vs_transfer/make_slide_figure.py`.
