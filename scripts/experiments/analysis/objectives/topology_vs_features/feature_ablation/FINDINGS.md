...
Raw data: [`feature_ablation_results.csv`](data/feature_ablation_results.csv),
[`feature_label_probe_results.csv`](data/feature_label_probe_results.csv),
[`feature_only_nm_results.csv`](data/feature_only_nm_results.csv).
