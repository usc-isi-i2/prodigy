...
Usage:
    python compare_free_preview.py --csv scripts/experiments/analysis/evaluation/shared_task_tables/node_regression/data/node_regression.csv
"""
...
def main() -> int:
    ...
    ap.add_argument("--csv", default="scripts/experiments/analysis/evaluation/shared_task_tables/node_regression/data/node_regression.csv")
