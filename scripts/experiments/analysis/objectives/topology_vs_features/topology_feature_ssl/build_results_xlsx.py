...
Reproduce:  python scripts/experiments/analysis/objectives/topology_vs_features/topology_feature_ssl/build_results_xlsx.py
"""
...
lines = [
    ...
    ("Reproduce", "python scripts/experiments/analysis/objectives/topology_vs_features/topology_feature_ssl/build_results_xlsx.py  (then recalc.py to cache formula values)"),
    ("Built", "2026-07-12"),
    ("", None),
