...
|---|---|---|
| `data/pair_lp/*__pair_lp.csv` | rescored LP, 5 datasets × (15 arms + 5 heuristic floors) × 3 negative kinds | verbatim from `exp/slp-evaluator-repair` @ `79e173a` (`scripts/experiments/analysis/evaluation/slp_evaluator_repair/results/`) |
