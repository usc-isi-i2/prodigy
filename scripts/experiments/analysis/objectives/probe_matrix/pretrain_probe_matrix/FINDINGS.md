...
- Regression: [`node_regression.csv`](../../../evaluation/shared_task_tables/node_regression/data/node_regression.csv)
- Static LP: [`static_link_prediction.csv`](../../../evaluation/shared_task_tables/static_link_prediction/data/static_link_prediction.csv)
- `features_only` floor: [`features_only_floor.csv`](../../../evaluation/shared_task_tables/node_regression/data/features_only_floor.csv)
- Classification: [`node_classification.csv`](../../../evaluation/shared_task_tables/node_classification/data/node_classification.csv)
- Figures: [`probe_matrix_heatmap.png`](figures/probe_matrix_heatmap.png),
  [`probe_matrix_delta_bars.png`](figures/probe_matrix_delta_bars.png)
- Reproduce aggregation + figures: `python3 scripts/experiments/analysis/objectives/probe_matrix/pretrain_probe_matrix/plot_probe_matrix.py`
