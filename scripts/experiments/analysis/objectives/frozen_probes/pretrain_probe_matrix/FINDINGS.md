...
- Regression: [`node_regression.csv`](../../../evaluation/task_tables/node_regression/data/node_regression.csv)
- Static LP: [`static_link_prediction.csv`](../../../evaluation/task_tables/static_link_prediction/data/static_link_prediction.csv)
- `features_only` floor: [`features_only_floor.csv`](../../../evaluation/task_tables/node_regression/data/features_only_floor.csv)
- Classification: [`node_classification.csv`](../../../evaluation/task_tables/node_classification/data/node_classification.csv)
...
- Reproduce aggregation + figures: `python3 scripts/experiments/analysis/objectives/frozen_probes/pretrain_probe_matrix/plot_probe_matrix.py`
