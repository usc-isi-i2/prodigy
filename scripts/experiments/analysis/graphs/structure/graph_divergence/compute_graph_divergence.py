...
Because loading a 75GB graph is heavy, launch this on Tucker yourself, e.g.:
    ...
    python scripts/experiments/analysis/graphs/structure/graph_divergence/compute_graph_divergence.py \
        --data-root /dataMeR1/phil/data \
        --out scripts/experiments/analysis/graphs/structure/graph_divergence/data/graph_divergence_data.json
...
def main() -> None:
    ...
    ap.add_argument("--out", default="scripts/experiments/analysis/graphs/structure/graph_divergence/data/graph_divergence_data.json")
