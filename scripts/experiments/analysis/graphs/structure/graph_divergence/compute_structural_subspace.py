...
Runs on Tucker, where the graphs live:
    ...
    python scripts/experiments/analysis/graphs/structure/graph_divergence/compute_structural_subspace.py \
        --data-root /dataMeR1/phil/data \
        --out scripts/experiments/analysis/graphs/structure/graph_divergence/data/structural_subspace.json
"""
