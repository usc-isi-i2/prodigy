...
/home/mhchu/miniconda3/envs/prodigy/bin/python \
  scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/analyze_path_feature_coupling.py
```
...
```bash
/home/mhchu/miniconda3/envs/prodigy/bin/python \
  scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/analyze_dimension_diagnostics.py
/home/mhchu/miniconda3/envs/prodigy/bin/python \
  scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/export_dimension_tables.py
```
...
```bash
/home/mhchu/miniconda3/envs/prodigy/bin/python \
  scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/analyze_neighbor_augmented_features.py
```
