...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/data/dimension_diagnostics.json",
    )
    parser.add_argument(
        "--node-out",
        default="scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/data/node_distance_per_dimension.csv",
    )
    parser.add_argument(
        "--graph-out",
        default="scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/data/graph_identity_per_dimension.csv",
    )
