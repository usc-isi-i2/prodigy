...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default="scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/data/neighbor_augmented_features.json",
    )
    parser.add_argument(
        "--projection-out",
        default="scripts/experiments/analysis/graphs/structure_features/path_feature_coupling/data/neighbor_augmented_3d.csv",
    )
