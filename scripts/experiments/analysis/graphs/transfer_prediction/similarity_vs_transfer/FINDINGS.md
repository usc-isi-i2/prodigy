...
- **Similarity** — [`compute_graph_divergence.py`](../../structure/graph_divergence/compute_graph_divergence.py)
  ...
  [`graph_divergence_data.json`](../../structure/graph_divergence/data/graph_divergence_data.json).
...
`~/.pyenv/versions/myenv/bin/python scripts/experiments/analysis/graphs/transfer_prediction/similarity_vs_transfer/make_slide_figure.py`.
