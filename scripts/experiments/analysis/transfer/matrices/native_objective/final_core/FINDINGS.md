...
/opt/homebrew/bin/python3.11 \
  scripts/experiments/analysis/transfer/matrices/native_objective/final_core/verify_prodigy_archive.py
```
...
```bash
/opt/homebrew/bin/python3.11 \
  scripts/experiments/analysis/transfer/matrices/native_objective/final_core/verify_experiment.py
```
