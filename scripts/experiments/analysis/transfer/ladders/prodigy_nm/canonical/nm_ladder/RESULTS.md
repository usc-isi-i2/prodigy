...
is a separate experiment: [`../nm_ladder_order_robustness/`](../../order_and_graph_set/nm_ladder_order_robustness/).
...
- Rungs 1/2/3/8: existing ladder (`scripts/experiments/analysis/transfer/ladders/prodigy_nm/canonical/nm_ladder/data/nmladder_results.csv`).
