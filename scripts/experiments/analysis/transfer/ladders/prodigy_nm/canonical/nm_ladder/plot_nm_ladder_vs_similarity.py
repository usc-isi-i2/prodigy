...
Derived (see below) from:
  - scripts/experiments/analysis/transfer/ladders/prodigy_nm/canonical/nm_ladder/data/nm_ladder_full.csv              (ladder OOD baselines)
  - scripts/experiments/analysis/transfer/matrices/prodigy_nm/single_source/nm_single_source_matrix/data/nm_single_source_matrix.csv  (donors)
  - scripts/experiments/analysis/graph_characterization/statistics/graph_divergence/data/graph_divergence_data.json (pairwise divergence)
