...
# scripts/experiments/analysis/transfer/ladders/prodigy_nm/baseline/nm_ladder/data/nmladder_results.csv (matched-40k, NM 3-shot 30-way).
...
def main() -> int:
    ...
    ap.add_argument("--ladder-csv",
                    default=str(repo_root / "scripts/experiments/analysis/transfer/ladders/prodigy_nm/baseline/nm_ladder/data/nmladder_results.csv"),
