...
```bash
python3 scripts/experiments/analysis/transfer/ablations/downstream/one_hop/nm_ladder_downstream/plot_downstream_event_study.py
```

```bash
python3 scripts/experiments/analysis/transfer/ablations/downstream/one_hop/nm_ladder_downstream/summarize_reg_vs_floor.py
```
