...
REPO_ROOT = next(
    p for p in Path(__file__).resolve().parents if (p / "AGENTS.md").is_file()
)
SETUP_PATH = REPO_ROOT / "scripts/experiments/setup/nm_ladder_downstream_nhop2/make_model_list.py"
