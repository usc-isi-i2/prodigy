...
MATCHED40K_H1_LADDER = REPO_ROOT / "scripts/experiments/analysis/transfer/ladders/prodigy_nm/canonical/nm_ladder/data/nm_ladder_full.csv"
MATCHED40K_H2_LADDER = (
    REPO_ROOT / "scripts/experiments/analysis/transfer/ablations/context_hops/nm_ladder_nhop2/data/nm_ladder_nhop2_order_A.csv"
)
