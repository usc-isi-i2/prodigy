...
/opt/homebrew/bin/python3.11 \
  scripts/experiments/analysis/transfer/ablations/source_exposure/nm_ladder_fixed_exposure_nhop2/analyze_results.py
```
...
/opt/homebrew/bin/python3.11 -m pytest -q \
  scripts/experiments/analysis/transfer/ablations/source_exposure/nm_ladder_fixed_exposure_nhop2/tests
```
