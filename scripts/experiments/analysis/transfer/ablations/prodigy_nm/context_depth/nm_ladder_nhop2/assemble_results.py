...
def main() -> int:
    ...
    parser.add_argument(
        "--hop1-long", type=Path,
        default=REPO_ROOT / "scripts/experiments/analysis/transfer/ladders/prodigy_nm/robustness/nm_ladder_order_robustness/data/nm_ladder_order_robustness_long.csv",
    )
