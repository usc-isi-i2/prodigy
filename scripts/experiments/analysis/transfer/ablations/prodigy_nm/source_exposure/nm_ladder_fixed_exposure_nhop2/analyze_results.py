...
SETUP = REPO_ROOT / "scripts/experiments/setup/nm_ladder_fixed_exposure_nhop2"
MATCHED40K_H1_LADDER = REPO_ROOT / "scripts/experiments/analysis/transfer/ladders/prodigy_nm/baseline/nm_ladder/data/nm_ladder_full.csv"
MATCHED40K_H2_LADDER = (
    REPO_ROOT / "scripts/experiments/analysis/transfer/ablations/prodigy_nm/context_depth/nm_ladder_nhop2/data/nm_ladder_nhop2_order_A.csv"
)
