...
```bash
python3 scripts/experiments/analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream_nhop2/assemble_results.py
python3 scripts/experiments/analysis/transfer/ablations/prodigy_nm/downstream/nm_ladder_downstream_nhop2/plot_results.py
```
