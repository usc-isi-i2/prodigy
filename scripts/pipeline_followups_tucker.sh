...
LOG_ROOT="${ROOT}/log/matrix_s0_eval" GPUS="2 3" \
...
STATE_ROOT="${ROOT}/state/ladder_s0" LOG_ROOT="${ROOT}/log/ladder_s0" GPUS="2 3" \
...
LOG_ROOT="${ROOT}/log/ladder_s0_eval" GPUS="2 3" \
...
STATE_ROOT="${ROOT}/state/primary_s1_s2" LOG_ROOT="${ROOT}/log/primary_s1_s2" GPUS="2 3" \
...
LOG_ROOT="${ROOT}/log/primary_s1_s2_eval" GPUS="2 3" \
