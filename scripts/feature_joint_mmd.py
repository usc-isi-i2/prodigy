...
out=root/'feature_joint_mmd_seven_s2026';out.mkdir(exist_ok=True)
...
names=[n for n in r['graphs'] if n not in {'covid_political','election2020'}]
...
median=float(np.median(pdist(pooled,'sqeuclidean')))
