...
# Load data
basedir = "/Users/philipp/projects/gfm/prodigy/midterm/converted_data_2022-10-17-00_2022-10-17-23/"
mdf = pd.concat([pd.read_csv(f) for f in glob.glob(basedir + "*.csv")], ignore_index=True)
