...
def load_dataset(params):
    ...
    return get_dataset_wrap(
        ...
        neighbor_sampling_method=params["neighbor_sampling_method"],
        pinsage_num_walks=params["pinsage_num_walks"],
        pinsage_walk_length=params["pinsage_walk_length"],
        pinsage_restart_prob=params["pinsage_restart_prob"],
        pinsage_topk=params["pinsage_topk"],
