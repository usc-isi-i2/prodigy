...
class TrainerFS():
    def __init__(self, dataset, parameter):
        ...
        if self.dataset_name in {"twitter", "midterm", "instagram_mention", "merged"} and self.original_features:
            self.Bert = None
        else:
    ...
    def _build_dataloaders(self, dataset, dataset_name):
        ...
        if dataset_name == "arxiv":
            ...
            from data.merged import get_merged_dataloader
            kwargs["root"] = self.parameter["root"]
            get_dataloader = get_merged_dataloader
        else:
