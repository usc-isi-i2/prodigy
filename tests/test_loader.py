...
from mixture_scaling.train import configure_sampling_backend, make_loader
...
def test_link_neighbor_loader_returns_local_labeled_pairs() -> None:
    ...
    if typing.WITH_TORCH_SPARSE:
        configure_sampling_backend({"sampling_backend": "torch_sparse"})
